...
export class CubismMotion extends ACubismMotion {
   ...
   * @return 作成されたインスタンス
   */
  public static create(json: Motion3, onFinishedMotionHandler?: (self: ACubismMotion) => void): CubismMotion {
   ...
   */
  public parse(motionJson: Motion3): void {
    ...
    this._motionData.points = Array.from({ length: json.getMotionTotalPointCount() }).map(() => new CubismMotionPoint());
